...
function Card() {
  return (
    <div className="mt-10">
        <h2 className="text-gradient text-[2rem] font-bold">
        ...
        <div className="flex  items-center justify-center mt-[56px]">
          <div className="flex flex-col items-center gap-[2rem]">
            <div className="tabs flex gap-16">
              {["Study", "Quiz", "Test", "Game", "Others"].map(
                (item, index) => (
                  <p
                    key={index}
                    className={`${
                      index == 0
                        ? "text-[#06286E] underline-text"
                        : "text-[#696671]"
                    } text-[20px] font-medium capitalize`}
                  >
                    {item}
                  </p>
                )
            ...
            <div className="card-area flex flex-col gap-[2rem]">
              <div className="relative overflow-hidden flex items-center justify-center card bg-gradient-to-bl text-white  from-[#06286E] from-10% to-[#164EC0] rounded-3xl w-[712px] h-[394px]">
                <div className="w-full flex items-center justify-between absolute top-0 left-0 right-0 p-[34px]">
                  <svg
                    width="35"
                    height="35"
                    viewBox="0 0 35 35"
                ...
                <p className="text-[2.5rem] font-bold">9 + 6 + 7x - 2x - 3</p>
              </div>
              <div className="flex items-center justify-between px-[50px]">
                ...
                >
                  <path
                    ...
                    fill="url(#paint0_linear_0_170)"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_0_170"
                      x1={15}
                      y1="0.184647"
                      x2={15}
                      y2="30.2034"
                ...
                <div className="flex items-center gap-[43px]">
                  ...
                  <p className="text-[24px] font-bold">01/10</p>
                  <button className="">
                    <svg
                      width={60}
                      height={61}
                    ...
                    >
                      <path
                        ...
                        fill="url(#paint0_linear_0_174)"
                      />
                      <defs>
                        <linearGradient
                          id="paint0_linear_0_174"
                          x1={30}
                          y1="0.194031"
                          x2={30}
                          y2="60.194"
                ...
                >
                  <path
                    ...
                    fill="url(#paint0_linear_0_175)"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_0_175"
                      x1={15}
                      y1="0.194031"
                      x2={15}
                      y2="30.194"
